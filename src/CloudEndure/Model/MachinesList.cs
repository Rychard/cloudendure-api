...
namespace CloudEndure.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class MachinesList :  IEquatable<MachinesList>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MachinesList" /> class.
        /// </summary>
        /// <param name="items">items.</param>
        public MachinesList(List<Machine> items = default(List<Machine>))
        {
            this.Items = items;
        }
        ...
        {
            return this.Equals(input as MachinesList);
        }

        /// <summary>
        /// Returns true if MachinesList instances are equal
        /// </summary>
        /// <param name="input">Instance of MachinesList to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MachinesList input)
        {
            if (input == null)
                return false;
