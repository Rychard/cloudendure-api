...
namespace CloudEndure.Model
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UsersList" /> class.
        /// </summary>
        /// <param name="items">items.</param>
        public UsersList(List<User> items = default(List<User>))
        {
            this.Items = items;
        }
        ...
        {
            return this.Equals(input as UsersList);
        }

        /// <summary>
        /// Returns true if UsersList instances are equal
        /// </summary>
        /// <param name="input">Instance of UsersList to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UsersList input)
        {
            if (input == null)
                return false;
