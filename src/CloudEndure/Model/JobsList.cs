...
namespace CloudEndure.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class JobsList :  IEquatable<JobsList>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="JobsList" /> class.
        /// </summary>
        /// <param name="items">items.</param>
        public JobsList(List<Job> items = default(List<Job>))
        {
            this.Items = items;
        }
        ...
        {
            return this.Equals(input as JobsList);
        }

        /// <summary>
        /// Returns true if JobsList instances are equal
        /// </summary>
        /// <param name="input">Instance of JobsList to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(JobsList input)
        {
            if (input == null)
                return false;
