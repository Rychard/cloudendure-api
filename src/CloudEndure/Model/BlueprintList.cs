...
namespace CloudEndure.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class BlueprintList :  IEquatable<BlueprintList>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="BlueprintList" /> class.
        /// </summary>
        /// <param name="items">items.</param>
        public BlueprintList(List<Blueprint> items = default(List<Blueprint>))
        {
            this.Items = items;
        }
        ...
        public List<Blueprint> Items { get; set; }
        ...
        {
            return this.Equals(input as BlueprintList);
        }

        /// <summary>
        /// Returns true if BlueprintList instances are equal
        /// </summary>
        /// <param name="input">Instance of BlueprintList to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(BlueprintList input)
        {
            if (input == null)
                return false;
