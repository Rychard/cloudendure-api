...
namespace CloudEndure.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class RegionsList :  IEquatable<RegionsList>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RegionsList" /> class.
        /// </summary>
        /// <param name="items">items.</param>
        public RegionsList(List<Region> items = default(List<Region>))
        {
            this.Items = items;
        }
        ...
        {
            return this.Equals(input as RegionsList);
        }

        /// <summary>
        /// Returns true if RegionsList instances are equal
        /// </summary>
        /// <param name="input">Instance of RegionsList to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RegionsList input)
        {
            if (input == null)
                return false;
