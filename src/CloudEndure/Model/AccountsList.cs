...
namespace CloudEndure.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class AccountsList :  IEquatable<AccountsList>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AccountsList" /> class.
        /// </summary>
        /// <param name="items">items.</param>
        public AccountsList(List<Account> items = default(List<Account>))
        {
            this.Items = items;
        }
        ...
        {
            return this.Equals(input as AccountsList);
        }

        /// <summary>
        /// Returns true if AccountsList instances are equal
        /// </summary>
        /// <param name="input">Instance of AccountsList to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AccountsList input)
        {
            if (input == null)
                return false;
