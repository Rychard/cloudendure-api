...
namespace CloudEndure.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class UsageList :  IEquatable<UsageList>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UsageList" /> class.
        /// </summary>
        /// <param name="items">items.</param>
        public UsageList(List<Usage> items = default(List<Usage>))
        {
            this.Items = items;
        }
        ...
        {
            return this.Equals(input as UsageList);
        }

        /// <summary>
        /// Returns true if UsageList instances are equal
        /// </summary>
        /// <param name="input">Instance of UsageList to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UsageList input)
        {
            if (input == null)
                return false;
