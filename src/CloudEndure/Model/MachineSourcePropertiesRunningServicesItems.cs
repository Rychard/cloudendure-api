...
namespace CloudEndure.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class MachineSourcePropertiesRunningServicesItems :  IEquatable<MachineSourcePropertiesRunningServicesItems>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MachineSourcePropertiesRunningServicesItems" /> class.
        /// </summary>
        /// <param name="serviceName">serviceName.</param>
        public MachineSourcePropertiesRunningServicesItems(string serviceName = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MachineSourcePropertiesRunningServicesItems {\n");
        ...
        {
            return this.Equals(input as MachineSourcePropertiesRunningServicesItems);
        }

        /// <summary>
        /// Returns true if MachineSourcePropertiesRunningServicesItems instances are equal
        /// </summary>
        /// <param name="input">Instance of MachineSourcePropertiesRunningServicesItems to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MachineSourcePropertiesRunningServicesItems input)
        {
            if (input == null)
                return false;
