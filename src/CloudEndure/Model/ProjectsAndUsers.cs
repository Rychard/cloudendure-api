...
namespace CloudEndure.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ProjectsAndUsers :  IEquatable<ProjectsAndUsers>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ProjectsAndUsers" /> class.
        /// </summary>
        /// <param name="items">items.</param>
        public ProjectsAndUsers(List<ProjectsAndUsersItems> items = default(List<ProjectsAndUsersItems>))
        {
            this.Items = items;
        }
        ...
        public List<ProjectsAndUsersItems> Items { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ProjectsAndUsers {\n");
        ...
        {
            return this.Equals(input as ProjectsAndUsers);
        }

        /// <summary>
        /// Returns true if ProjectsAndUsers instances are equal
        /// </summary>
        /// <param name="input">Instance of ProjectsAndUsers to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProjectsAndUsers input)
        {
            if (input == null)
                return false;
