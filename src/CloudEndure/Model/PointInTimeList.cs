...
namespace CloudEndure.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class PointInTimeList :  IEquatable<PointInTimeList>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PointInTimeList" /> class.
        /// </summary>
        /// <param name="items">items.</param>
        public PointInTimeList(List<PointInTime> items = default(List<PointInTime>))
        {
            this.Items = items;
        }
        ...
        public List<PointInTime> Items { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PointInTimeList {\n");
        ...
        {
            return this.Equals(input as PointInTimeList);
        }

        /// <summary>
        /// Returns true if PointInTimeList instances are equal
        /// </summary>
        /// <param name="input">Instance of PointInTimeList to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PointInTimeList input)
        {
            if (input == null)
                return false;
