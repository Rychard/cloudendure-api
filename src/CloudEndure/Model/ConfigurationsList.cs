...
namespace CloudEndure.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ConfigurationsList :  IEquatable<ConfigurationsList>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ConfigurationsList" /> class.
        /// </summary>
        /// <param name="items">items.</param>
        public ConfigurationsList(List<Configurations> items = default(List<Configurations>))
        {
            this.Items = items;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ConfigurationsList {\n");
        ...
        {
            return this.Equals(input as ConfigurationsList);
        }

        /// <summary>
        /// Returns true if ConfigurationsList instances are equal
        /// </summary>
        /// <param name="input">Instance of ConfigurationsList to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ConfigurationsList input)
        {
            if (input == null)
                return false;
