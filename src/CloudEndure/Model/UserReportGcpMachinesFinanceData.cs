...
namespace CloudEndure.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class UserReportGcpMachinesFinanceData :  IEquatable<UserReportGcpMachinesFinanceData>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UserReportGcpMachinesFinanceData" /> class.
        /// </summary>
        /// <param name="items">items.</param>
        public UserReportGcpMachinesFinanceData(List<GcpMachinesFinanceData> items = default(List<GcpMachinesFinanceData>))
        {
            this.Items = items;
        }
        ...
        public List<GcpMachinesFinanceData> Items { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class UserReportGcpMachinesFinanceData {\n");
        ...
        {
            return this.Equals(input as UserReportGcpMachinesFinanceData);
        }

        /// <summary>
        /// Returns true if UserReportGcpMachinesFinanceData instances are equal
        /// </summary>
        /// <param name="input">Instance of UserReportGcpMachinesFinanceData to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UserReportGcpMachinesFinanceData input)
        {
            if (input == null)
                return false;
