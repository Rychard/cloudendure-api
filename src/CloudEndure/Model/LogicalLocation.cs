...
namespace CloudEndure.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class LogicalLocation :  IEquatable<LogicalLocation>
    {
        /// <summary>
        ...
        public LogicalLocation(string locationId = default(string), string name = default(string))
        {
        ...
        {
            return this.Equals(input as LogicalLocation);
        }

        /// <summary>
        /// Returns true if LogicalLocation instances are equal
        /// </summary>
        /// <param name="input">Instance of LogicalLocation to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LogicalLocation input)
        {
            if (input == null)
                return false;
