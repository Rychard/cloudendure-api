...
namespace CloudEndure.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class UserReports :  IEquatable<UserReports>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UserReports" /> class.
        /// </summary>
        /// <param name="items">items.</param>
        public UserReports(List<UserReport> items = default(List<UserReport>))
        {
            this.Items = items;
        }
        ...
        public List<UserReport> Items { get; set; }
        ...
        {
            return this.Equals(input as UserReports);
        }

        /// <summary>
        /// Returns true if UserReports instances are equal
        /// </summary>
        /// <param name="input">Instance of UserReports to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UserReports input)
        {
            if (input == null)
                return false;
