...
namespace CloudEndure.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ProjectCeAdminProperties :  IEquatable<ProjectCeAdminProperties>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ProjectCeAdminProperties" /> class.
        /// </summary>
        /// <param name="comments">comments.</param>
        /// <param name="history">history.</param>
        public ProjectCeAdminProperties(string comments = default(string), string history = default(string))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ProjectCeAdminProperties {\n");
        ...
        {
            return this.Equals(input as ProjectCeAdminProperties);
        }

        /// <summary>
        /// Returns true if ProjectCeAdminProperties instances are equal
        /// </summary>
        /// <param name="input">Instance of ProjectCeAdminProperties to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProjectCeAdminProperties input)
        {
            if (input == null)
                return false;
