...
namespace CloudEndure.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class MachineSourcePropertiesRunningServices :  IEquatable<MachineSourcePropertiesRunningServices>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MachineSourcePropertiesRunningServices" /> class.
        /// </summary>
        /// <param name="items">items.</param>
        /// <param name="lastUpdatedDateTime">lastUpdatedDateTime.</param>
        public MachineSourcePropertiesRunningServices(List<MachineSourcePropertiesRunningServicesItems> items = default(List<MachineSourcePropertiesRunningServicesItems>), DateTime? lastUpdatedDateTime = default(DateTime?))
        {
            this.Items = items;
        ...
        public List<MachineSourcePropertiesRunningServicesItems> Items { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MachineSourcePropertiesRunningServices {\n");
        ...
        {
            return this.Equals(input as MachineSourcePropertiesRunningServices);
        }

        /// <summary>
        /// Returns true if MachineSourcePropertiesRunningServices instances are equal
        /// </summary>
        /// <param name="input">Instance of MachineSourcePropertiesRunningServices to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MachineSourcePropertiesRunningServices input)
        {
            if (input == null)
                return false;
