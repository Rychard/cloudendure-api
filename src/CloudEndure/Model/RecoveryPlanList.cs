...
namespace CloudEndure.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class RecoveryPlanList :  IEquatable<RecoveryPlanList>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RecoveryPlanList" /> class.
        /// </summary>
        /// <param name="items">items.</param>
        public RecoveryPlanList(List<RecoveryPlan> items = default(List<RecoveryPlan>))
        {
            this.Items = items;
        }
        ...
        public List<RecoveryPlan> Items { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class RecoveryPlanList {\n");
        ...
        {
            return this.Equals(input as RecoveryPlanList);
        }

        /// <summary>
        /// Returns true if RecoveryPlanList instances are equal
        /// </summary>
        /// <param name="input">Instance of RecoveryPlanList to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RecoveryPlanList input)
        {
            if (input == null)
                return false;
