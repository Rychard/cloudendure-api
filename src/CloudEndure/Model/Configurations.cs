...
namespace CloudEndure.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class Configurations :  IEquatable<Configurations>
    {
        /// <summary>
        ...
        public Configurations(string name = default(string), string value = default(string))
        {
            this.Name = name;
            this.Value = value;
        }
        ...
        {
            return this.Equals(input as Configurations);
        }

        /// <summary>
        /// Returns true if Configurations instances are equal
        /// </summary>
        /// <param name="input">Instance of Configurations to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(Configurations input)
        {
            if (input == null)
                return false;
