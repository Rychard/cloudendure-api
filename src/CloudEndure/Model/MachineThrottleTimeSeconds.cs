...
{
    /// <summary>
    /// MachineThrottleTimeSeconds
    /// </summary>
    [DataContract]
        public partial class MachineThrottleTimeSeconds :  IEquatable<MachineThrottleTimeSeconds>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MachineThrottleTimeSeconds" /> class.
        /// </summary>
        /// <param name="credits">time to throttle the machine in seconds.</param>
        public MachineThrottleTimeSeconds(int? credits = default(int?))
        {
            this.Credits = credits;
        }
        
        /// <summary>
        /// time to throttle the machine in seconds
        /// </summary>
        /// <value>time to throttle the machine in seconds</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MachineThrottleTimeSeconds {\n");
        ...
        {
            return this.Equals(input as MachineThrottleTimeSeconds);
        }

        /// <summary>
        /// Returns true if MachineThrottleTimeSeconds instances are equal
        /// </summary>
        /// <param name="input">Instance of MachineThrottleTimeSeconds to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MachineThrottleTimeSeconds input)
        {
            if (input == null)
                return false;
