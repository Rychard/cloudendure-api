...
namespace CloudEndure.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ProjectsList :  IEquatable<ProjectsList>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ProjectsList" /> class.
        /// </summary>
        /// <param name="items">items.</param>
        public ProjectsList(List<Project> items = default(List<Project>))
        {
            this.Items = items;
        }
        ...
        {
            return this.Equals(input as ProjectsList);
        }

        /// <summary>
        /// Returns true if ProjectsList instances are equal
        /// </summary>
        /// <param name="input">Instance of ProjectsList to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ProjectsList input)
        {
            if (input == null)
                return false;
