...
namespace CloudEndure.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class PopulateJobNames :  IEquatable<PopulateJobNames>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PopulateJobNames" /> class.
        /// </summary>
        /// <param name="jobNames">jobNames.</param>
        public PopulateJobNames(List<string> jobNames = default(List<string>))
        {
            this.JobNames = jobNames;
        }
        
        /// <summary>
        /// Gets or Sets JobNames
        /// </summary>
        [DataMember(Name="jobNames", EmitDefaultValue=false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PopulateJobNames {\n");
            sb.Append("  JobNames: ").Append(JobNames).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as PopulateJobNames);
        }

        /// <summary>
        /// Returns true if PopulateJobNames instances are equal
        /// </summary>
        /// <param name="input">Instance of PopulateJobNames to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PopulateJobNames input)
        {
            if (input == null)
                return false;
            ...
            return 
                (
                    this.JobNames == input.JobNames ||
                    this.JobNames != null &&
                    input.JobNames != null &&
                    this.JobNames.SequenceEqual(input.JobNames)
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.JobNames != null)
                    hashCode = hashCode * 59 + this.JobNames.GetHashCode();
                return hashCode;
            }
        }
    }
