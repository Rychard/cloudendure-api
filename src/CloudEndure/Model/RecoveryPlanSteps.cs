...
namespace CloudEndure.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class RecoveryPlanSteps :  IEquatable<RecoveryPlanSteps>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RecoveryPlanSteps" /> class.
        /// </summary>
        /// <param name="items">items.</param>
        public RecoveryPlanSteps(List<RecoveryPlanStep> items = default(List<RecoveryPlanStep>))
        {
            this.Items = items;
        }
        ...
        public List<RecoveryPlanStep> Items { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class RecoveryPlanSteps {\n");
        ...
        {
            return this.Equals(input as RecoveryPlanSteps);
        }

        /// <summary>
        /// Returns true if RecoveryPlanSteps instances are equal
        /// </summary>
        /// <param name="input">Instance of RecoveryPlanSteps to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(RecoveryPlanSteps input)
        {
            if (input == null)
                return false;
