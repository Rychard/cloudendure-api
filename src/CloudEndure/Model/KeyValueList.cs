...
namespace CloudEndure.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class KeyValueList :  IEquatable<KeyValueList>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="KeyValueList" /> class.
        /// </summary>
        /// <param name="items">items.</param>
        public KeyValueList(List<ReplicationConfigurationReplicationTags> items = default(List<ReplicationConfigurationReplicationTags>))
        {
            this.Items = items;
        }
        ...
        public List<ReplicationConfigurationReplicationTags> Items { get; set; }
        ...
        {
            return this.Equals(input as KeyValueList);
        }

        /// <summary>
        /// Returns true if KeyValueList instances are equal
        /// </summary>
        /// <param name="input">Instance of KeyValueList to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(KeyValueList input)
        {
            if (input == null)
                return false;
