...
namespace CloudEndure.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class UpgradeCounterDelay :  IEquatable<UpgradeCounterDelay>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UpgradeCounterDelay" /> class.
        /// </summary>
        /// <param name="sleep">sleep.</param>
        public UpgradeCounterDelay(int? sleep = default(int?))
        {
            this.Sleep = sleep;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class UpgradeCounterDelay {\n");
        ...
        {
            return this.Equals(input as UpgradeCounterDelay);
        }

        /// <summary>
        /// Returns true if UpgradeCounterDelay instances are equal
        /// </summary>
        /// <param name="input">Instance of UpgradeCounterDelay to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UpgradeCounterDelay input)
        {
            if (input == null)
                return false;
