...
namespace CloudEndure.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class CloudsList :  IEquatable<CloudsList>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CloudsList" /> class.
        /// </summary>
        /// <param name="items">items.</param>
        public CloudsList(List<Cloud> items = default(List<Cloud>))
        {
            this.Items = items;
        }
        ...
        public List<Cloud> Items { get; set; }
        ...
        {
            return this.Equals(input as CloudsList);
        }

        /// <summary>
        /// Returns true if CloudsList instances are equal
        /// </summary>
        /// <param name="input">Instance of CloudsList to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CloudsList input)
        {
            if (input == null)
                return false;
