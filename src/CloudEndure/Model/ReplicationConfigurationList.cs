...
namespace CloudEndure.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ReplicationConfigurationList :  IEquatable<ReplicationConfigurationList>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ReplicationConfigurationList" /> class.
        /// </summary>
        /// <param name="items">items.</param>
        public ReplicationConfigurationList(List<ReplicationConfiguration> items = default(List<ReplicationConfiguration>))
        {
            this.Items = items;
        }
        ...
        public List<ReplicationConfiguration> Items { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ReplicationConfigurationList {\n");
        ...
        {
            return this.Equals(input as ReplicationConfigurationList);
        }

        /// <summary>
        /// Returns true if ReplicationConfigurationList instances are equal
        /// </summary>
        /// <param name="input">Instance of ReplicationConfigurationList to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ReplicationConfigurationList input)
        {
            if (input == null)
                return false;
