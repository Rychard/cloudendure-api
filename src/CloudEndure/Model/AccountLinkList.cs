...
namespace CloudEndure.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class AccountLinkList :  IEquatable<AccountLinkList>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AccountLinkList" /> class.
        /// </summary>
        /// <param name="items">items.</param>
        public AccountLinkList(List<AccountLink> items = default(List<AccountLink>))
        {
            this.Items = items;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AccountLinkList {\n");
        ...
        {
            return this.Equals(input as AccountLinkList);
        }

        /// <summary>
        /// Returns true if AccountLinkList instances are equal
        /// </summary>
        /// <param name="input">Instance of AccountLinkList to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AccountLinkList input)
        {
            if (input == null)
                return false;
