...
namespace CloudEndure.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class CloudCredentialsList :  IEquatable<CloudCredentialsList>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CloudCredentialsList" /> class.
        /// </summary>
        /// <param name="items">items.</param>
        public CloudCredentialsList(List<CloudCredentials> items = default(List<CloudCredentials>))
        {
            this.Items = items;
        }
        ...
        public List<CloudCredentials> Items { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CloudCredentialsList {\n");
        ...
        {
            return this.Equals(input as CloudCredentialsList);
        }

        /// <summary>
        /// Returns true if CloudCredentialsList instances are equal
        /// </summary>
        /// <param name="input">Instance of CloudCredentialsList to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CloudCredentialsList input)
        {
            if (input == null)
                return false;
