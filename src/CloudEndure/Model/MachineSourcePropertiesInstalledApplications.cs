...
namespace CloudEndure.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class MachineSourcePropertiesInstalledApplications :  IEquatable<MachineSourcePropertiesInstalledApplications>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MachineSourcePropertiesInstalledApplications" /> class.
        /// </summary>
        /// <param name="items">items.</param>
        /// <param name="lastUpdatedDateTime">lastUpdatedDateTime.</param>
        public MachineSourcePropertiesInstalledApplications(List<MachineSourcePropertiesInstalledApplicationsItems> items = default(List<MachineSourcePropertiesInstalledApplicationsItems>), DateTime? lastUpdatedDateTime = default(DateTime?))
        {
            this.Items = items;
        ...
        public List<MachineSourcePropertiesInstalledApplicationsItems> Items { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MachineSourcePropertiesInstalledApplications {\n");
        ...
        {
            return this.Equals(input as MachineSourcePropertiesInstalledApplications);
        }

        /// <summary>
        /// Returns true if MachineSourcePropertiesInstalledApplications instances are equal
        /// </summary>
        /// <param name="input">Instance of MachineSourcePropertiesInstalledApplications to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MachineSourcePropertiesInstalledApplications input)
        {
            if (input == null)
                return false;
