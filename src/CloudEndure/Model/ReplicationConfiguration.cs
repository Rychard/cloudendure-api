...
namespace CloudEndure.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ReplicationConfiguration :  IEquatable<ReplicationConfiguration>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ReplicationConfiguration" /> class.
        /// </summary>
        ...
        /// <param name="cloudCredentials">The ID for the cloudCredentials object containing the credentials to be used for accessing the target cloud..</param>
        ...
        public ReplicationConfiguration(string volumeEncryptionKey = default(string), List<ReplicationConfigurationReplicationTags> replicationTags = default(List<ReplicationConfigurationReplicationTags>), bool? disablePublicIp = default(bool?), string subnetHostProject = default(string), string replicationSoftwareDownloadSource = default(string), string replicationServerType = default(string), bool? useLowCostDisks = default(bool?), string computeLocationId = default(string), string cloudCredentials = default(string), string subnetId = default(string), string logicalLocationId = default(string), int? bandwidthThrottling = default(int?), bool? useDedicatedServer = default(bool?), string zone = default(string), List<string> replicatorSecurityGroupIDs = default(List<string>), bool? usePrivateIp = default(bool?), string proxyUrl = default(string), bool? volumeEncryptionAllowed = default(bool?), string objectStorageLocation = default(string), bool? archivingEnabled = default(bool?), string converterType = default(string), string storageLocationId = default(string))
        {
        ...
        /// <summary>
        /// The ID for the cloudCredentials object containing the credentials to be used for accessing the target cloud.
        /// </summary>
        /// <value>The ID for the cloudCredentials object containing the credentials to be used for accessing the target cloud.</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("  CloudCredentials: ").Append(CloudCredentials).Append("\n");
        ...
        {
            return this.Equals(input as ReplicationConfiguration);
        }
        ...
        /// <returns>Boolean</returns>
        public bool Equals(ReplicationConfiguration input)
        {
            if (input == null)
                return false;
