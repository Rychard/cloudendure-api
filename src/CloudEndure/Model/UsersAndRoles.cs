...
namespace CloudEndure.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class UsersAndRoles :  IEquatable<UsersAndRoles>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UsersAndRoles" /> class.
        /// </summary>
        /// <param name="items">items.</param>
        public UsersAndRoles(List<UsersAndRolesItems> items = default(List<UsersAndRolesItems>))
        {
            this.Items = items;
        }
        ...
        public List<UsersAndRolesItems> Items { get; set; }
        ...
        {
            return this.Equals(input as UsersAndRoles);
        }

        /// <summary>
        /// Returns true if UsersAndRoles instances are equal
        /// </summary>
        /// <param name="input">Instance of UsersAndRoles to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UsersAndRoles input)
        {
            if (input == null)
                return false;
