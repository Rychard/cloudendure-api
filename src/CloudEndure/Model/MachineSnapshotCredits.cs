...
{
    /// <summary>
    /// MachineSnapshotCredits
    /// </summary>
    [DataContract]
        public partial class MachineSnapshotCredits :  IEquatable<MachineSnapshotCredits>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MachineSnapshotCredits" /> class.
        /// </summary>
        /// <param name="credits">Mbps to use for Data Replication (zero means no throttling)..</param>
        public MachineSnapshotCredits(int? credits = default(int?))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class MachineSnapshotCredits {\n");
        ...
        {
            return this.Equals(input as MachineSnapshotCredits);
        }

        /// <summary>
        /// Returns true if MachineSnapshotCredits instances are equal
        /// </summary>
        /// <param name="input">Instance of MachineSnapshotCredits to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(MachineSnapshotCredits input)
        {
            if (input == null)
                return false;
