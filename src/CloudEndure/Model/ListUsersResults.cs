...
namespace CloudEndure.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ListUsersResults :  IEquatable<ListUsersResults>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ListUsersResults" /> class.
        /// </summary>
        /// <param name="items">items.</param>
        public ListUsersResults(List<ListUsersResult> items = default(List<ListUsersResult>))
        {
            this.Items = items;
        }
        ...
        public List<ListUsersResult> Items { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ListUsersResults {\n");
        ...
        {
            return this.Equals(input as ListUsersResults);
        }

        /// <summary>
        /// Returns true if ListUsersResults instances are equal
        /// </summary>
        /// <param name="input">Instance of ListUsersResults to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ListUsersResults input)
        {
            if (input == null)
                return false;
