...
namespace CloudEndure.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class AccountRequestList :  IEquatable<AccountRequestList>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AccountRequestList" /> class.
        /// </summary>
        /// <param name="items">items.</param>
        public AccountRequestList(List<AccountRequest> items = default(List<AccountRequest>))
        {
            this.Items = items;
        }
        ...
        public List<AccountRequest> Items { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class AccountRequestList {\n");
        ...
        {
            return this.Equals(input as AccountRequestList);
        }

        /// <summary>
        /// Returns true if AccountRequestList instances are equal
        /// </summary>
        /// <param name="input">Instance of AccountRequestList to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AccountRequestList input)
        {
            if (input == null)
                return false;
